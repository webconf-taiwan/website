...
<template>
  ...
  >
    ...
    ></div>
    <div
      class="float-blocks absolute bottom-[41.11px] left-[76.16px] block size-[22.05px] bg-[#2F2ADB]"
    ></div>
    <div
      class="float-blocks absolute bottom-[15.06px] left-[120.27px] block size-[22.05px] bg-[#2F2ADB]"
    ></div>
  </div>
</template>
