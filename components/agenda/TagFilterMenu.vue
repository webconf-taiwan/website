...
<template>
  <section
    v-show="isOpen"
    class="tag-filter-menu absolute left-0 top-0 z-50 size-full border-webconf-gray bg-black p-4 xl:w-[228px] xl:border-r xl:pl-4 2xl:w-[260px] 2xl:pl-12"
  >
    <button
    ...
    <ul class="mt-7 xl:mt-6">
      ...
      >
        <label class="flex items-center gap-[10px] text-body-18">
          ...
          <span
            :class="{
              'border-white bg-white': selectedTags.includes(tag as AgendaTag),
            }"
            class="inline-block size-3 border-2 border-webconf-blue duration-300"
          ></span>
