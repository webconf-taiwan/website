<template>
  <div v-if="currentPageName === 'speaker' || currentPageName === 'agenda'" ref="specialFilter">
    <div
      class="w-full md:w-[600px] lg:w-[750px] md:m-auto px-4 pt-4 pb-[6px] bg-custom-gray-800 border-t border-b md:border-r md:border-l md:rounded border-custom-teal-700 relative z-20"
    >
    ...
    <div
      class="w-[93%] md:w-[558px] lg:w-[698px] h-8 bg-custom-gray-800 border border-custom-teal-700 rounded opacity-60 relative bottom-7 left-1/2 transform -translate-x-1/2"
    ></div>
    <div
      class="w-[88%] md:w-[528px] lg:w-[660px] h-8 bg-custom-gray-800 border border-custom-teal-700 rounded opacity-30 relative bottom-[56px] left-1/2 transform -translate-x-1/2"
    ></div>
  </div>
</template>
