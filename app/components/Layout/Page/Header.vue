    ...
    >
      <ul ref="menuRef" class="flex flex-col py-4">
        ...
        >
          ...
          >
            <span class="font-serif text-[32px] font-bold italic leading-[1.2] tracking-[0.02em]">
              {{ link.label_en }}
            </span>
            <span class="px-3 py-1 font-Noto text-[16px] font-medium leading-none tracking-[0.1em]">
              {{ link.label }}
            </span>
          </a>
        </li>
